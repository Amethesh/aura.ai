...
const InputBox = () => {
  return (
    <section className="w-[700px] bg-[rgba(17,17,17,0.8)] border border-white/10 backdrop-blur-[5px] rounded-3xl px-2 py-4">
      ...
      <div className="mt-2 flex gap-2">
        <div className="w-[100px] h-[75px] rounded-2xl border border-[#282828] shadow-[0_4px_4px] shadow-black relative">
          <p className="absolute w-full h-full bg-black/40 rounded-2xl flex justify-center items-center">
            Model
          </p>
          <Image
